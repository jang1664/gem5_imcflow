...
$BUILD_DIR/simv_imcflow_gem5 +SOCKET_PORT=$SOCKET_PORT +SRAM_BACKDOOR=$SRAM_BACKDOOR +FSIM_LOG_DIR=$LOG_DIR/fsim_logs +fsdbfile+imcflow_gem5.fsdb +fsdb+autoflush > "$LOG_DIR/vcs_sim.log" 2>&1 &
VCS_PID=$!
